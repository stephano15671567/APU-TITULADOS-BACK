...
FROM alumnos
LEFT JOIN asigancionesprofesores AS asig_guia ON alumnos.RUT = asig_guia.alumno_RUT AND asig_guia.rol = 'guia'
LEFT JOIN profesores AS p_guia ON asig_guia.profesor_id = p_guia.profesor_id
LEFT JOIN asigancionesprofesores AS asig_informante ON alumnos.RUT = asig_informante.alumno_RUT AND asig_informante.rol = 'informante'
LEFT JOIN profesores AS p_informante ON asig_informante.profesor_id = p_informante.profesor_id
LEFT JOIN asigancionesprofesores AS asig_secretario ON alumnos.RUT = asig_secretario.alumno_RUT AND asig_secretario.rol = 'secretario'
LEFT JOIN profesores AS p_secretario ON asig_secretario.profesor_id = p_secretario.profesor_id
LEFT JOIN asigancionesprofesores AS asig_presidente ON alumnos.RUT = asig_presidente.alumno_RUT AND asig_presidente.rol = 'presidente'
